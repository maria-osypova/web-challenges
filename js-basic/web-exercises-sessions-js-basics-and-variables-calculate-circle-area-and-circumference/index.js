...
const pizzaRadius = 10;
const pizzaArea = Math.PI * pizzaRadius ** 2;
const pizzaCircumference = Math.PI * pizzaRadius * 2;

console.log(
  "We know you're on a diet, and it's important for you to know the area of the pizza you've eaten and its circumference:",
  pizzaArea,
  "cm² and",
  pizzaCircumference,
  "cm², respectively!"
